...
Shader "Vefects/SH_Vefects_VFX_URP_Goo_Splash_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord10 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord70 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 temp_output_14_0 = ( texCoord10 + lerpResult63 );
				...
				float2 texCoord165 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( input.ase_texcoord9.z + saturate( clampResult9_g2 ) );
				...
				float3 BaseColor = color20;
				float3 Normal = normal18;
				float3 Emission = emission50;
				float3 Specular = temp_cast_2;
				float Metallic = 0;
				float Smoothness = lerpResult48;
				float Occlusion = 1;
				float Alpha = opacity175;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord165 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( input.ase_texcoord3.z + saturate( clampResult9_g2 ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord165 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( input.ase_texcoord2.z + saturate( clampResult9_g2 ) );
				float smoothstepResult171 = smoothstep( temp_output_174_0 , ( temp_output_174_0 + _ErosionSmoothness ) , tex2DNode11.g);
				float opacity175 = smoothstepResult171;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord70 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner72 = ( 1.0 * _Time.y * _NoiseTextureDistortionPan + ( texCoord70 * _NoiseTextureDistortionScale ));
				float lerpResult61 = lerp( -1.0 , 1.0 , tex2D( _NoiseTextureDistortion, panner72 ).g);
				float2 temp_cast_0 = (lerpResult61).xx;
				float2 lerpResult63 = lerp( float2( 0,0 ) , temp_cast_0 , _NoiseDistortionLerp);
				...
				float2 texCoord165 = input.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( input.ase_texcoord5.z + saturate( clampResult9_g2 ) );
				float4 tex2DNode11 = tex2D( _NoiseTexture, temp_output_14_0 );
				float smoothstepResult171 = smoothstep( temp_output_174_0 , ( temp_output_174_0 + _ErosionSmoothness ) , tex2DNode11.g);
				float opacity175 = smoothstepResult171;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 texCoord165 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult9_g2 = clamp( ( ( length( (float2( -1,-1 ) + (texCoord165 - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) ) + -0.0 ) * 0.3 ) , 0.0 , 1.0 );
				float temp_output_174_0 = ( input.ase_texcoord.z + saturate( clampResult9_g2 ) );
				float2 texCoord10 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord70 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner72 = ( 1.0 * _Time.y * _NoiseTextureDistortionPan + ( texCoord70 * _NoiseTextureDistortionScale ));
				float lerpResult61 = lerp( -1.0 , 1.0 , tex2D( _NoiseTextureDistortion, panner72 ).g);
				float2 temp_cast_0 = (lerpResult61).xx;
				float2 lerpResult63 = lerp( float2( 0,0 ) , temp_cast_0 , _NoiseDistortionLerp);
				...
				surfaceDescription.Alpha = opacity175;
...
Node;AmplifyShaderEditor.Vector2Node;73;-7040,896;Inherit;False;Property;_NoiseTextureDistortionScale;Noise Texture Distortion Scale;13;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;74;-6400,896;Inherit;False;Property;_NoiseTextureDistortionPan;Noise Texture Distortion Pan;14;0;Create;True;0;0;0;False;0;False;-0.05,-0.1;-0.05,-0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-4864,384;Inherit;False;Property;_NoiseDistortionLerp;Noise Distortion Lerp;15;0;Create;True;0;0;0;False;0;False;0.03;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;173;-2944,1536;Inherit;False;Property;_ErosionSmoothness;Erosion Smoothness;19;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1536,640;Inherit;False;Property;_NormalIntensity;Normal Intensity;11;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-2688,-1024;Inherit;False;Property;_FresnelPower;Fresnel Power;17;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;59;-2688,-896;Inherit;False;Property;_FresnelBias;Fresnel Bias;18;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-2688,-1152;Inherit;False;Property;_FresnelScale;Fresnel Scale;16;0;Create;True;0;0;0;False;3;Space(33);Header(Fresnel);Space(13);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;178;1024,0;Inherit;False;Property;_Src;Src;21;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;179;1280,0;Inherit;False;Property;_Dst;Dst;22;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;180;1536,0;Inherit;False;Property;_ZWrite;ZWrite;23;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;181;1792,0;Inherit;False;Property;_ZTest;ZTest;24;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;177;768,0;Inherit;False;Property;_Cull;Cull;20;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;183;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;1;6;176;0
ASEEND*/
//CHKSM=FADCC6BE2C14213B250EE6A699AB818261B7A51E