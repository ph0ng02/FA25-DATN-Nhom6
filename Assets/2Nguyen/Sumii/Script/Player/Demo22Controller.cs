...
public class Demo22Controller : MonoBehaviour
{
    ...
    [Header("Special Attack Settings (Q / Gamepad Button)")]
    ...
    void HandleAttack()
    {
        if (Input.GetButtonDown("JoystickFire")) // gán trong Input Manager
        {
    ...
    {
        if (Input.GetButtonDown("JoystickSkill")) // gán trong Input Manager
        {
